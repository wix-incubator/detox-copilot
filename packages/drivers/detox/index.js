...
exports.DetoxFrameworkDriver = void 0;
const detox = __importStar(require("detox"));
const globals_1 = require("@jest/globals");
class DetoxFrameworkDriver {
    ...
    captureSnapshotImage() {
        return __awaiter(this, void 0, void 0, function* () {
            const fileName = `temp/snapshot_detox_${Date.now()}.png`;
            try {
                return yield detox.device.takeScreenshot(fileName);
            }
            catch (_error) {
                return undefined;
            }
...
exports.DetoxFrameworkDriver = DetoxFrameworkDriver;
