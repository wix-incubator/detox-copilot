          ...
          items: [
            {
              ...
              guidelines: [
                "Use ONLY test IDs (accessibility identifiers) to uniquely identify elements. This is the best-practice matcher.",
                "Do not use other matchers like `by.label` or `by.text` to identify elements. They are not reliable.",
              ],
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              guidelines: [
                "Tapping on edges of elements might work better when adding a small offset to the point.",
              ],
            },
            {
            ...
            },
            {
              ...
              example:
                "await element(by.id('usernameInput')).typeText('myusername');",
            ...
            },
            {
              ...
              example:
                "await element(by.id('textField')).replaceText('new text');",
            },
            {
              signature: "clearText()",
            ...
            },
            {
              ...
              description:
                "Simulates tapping the return key on the keyboard while the element is focused.",
              example: "await element(by.id('textField')).tapReturnKey();",
            },
            {
              signature: "tapBackspaceKey()",
              description:
                "Simulates tapping the backspace key on the keyboard while the element is focused.",
              example: "await element(by.id('textField')).tapBackspaceKey();",
            },
            {
              signature: "adjustSliderToPosition(normalizedPosition: number)",
              description:
                "Adjusts slider to a normalized position between 0 and 1.",
              example:
                "await element(by.id('slider')).adjustSliderToPosition(0.75);",
            },
            {
              signature:
                "scroll(offset: number, direction: string, startPositionX?: number, startPositionY?: number)",
            ...
            {
              signature:
                "scrollTo(edge: string, startPositionX?: number, startPositionY?: number)",
            ...
            {
              signature:
                "waitFor(element: Matcher).toBeVisible(percent?: number).whileElement(element: Matcher).scroll(offset: number, direction: string)",
              description:
                "Continuously performs an action while waiting for an expectation to be fulfilled.",
              example: `
await waitFor(element(by.id('detox_temp_0_0_0_0_0_0_0_0_0_0_0_0_1_0_0_2_0_1_0')))
  .toBeVisible()
  ...
  .scroll(50, 'down');`,
            ...
            {
              signature:
                "swipe(direction: string, speed?: string, normalizedOffset?: number)",
            ...
            {
              signature:
                "setDatePickerDate(dateString: string, dateFormat: string)",
              description: "Sets date picker to a specific date.",
              example:
                "await element(by.id('datePicker')).setDatePickerDate('2023-05-25', 'yyyy-MM-dd');",
            },
            {
            ...
            },
            {
              ...
              example: `
const attributes = await element(by.id('detox_temp_0_0_0_0_0_0_0_0_0_0_0_0_1_0_0_2_0_1_0')).getAttributes();
jestExpect(attributes.text).toBe('Tap Me');`,
            },
            {
              ...
              example:
                "const imagePath = await element(by.id('menuRoot')).takeScreenshot('menu_screenshot');",
            },
            {
              signature:
          ...
          items: [
            {
              ...
              description:
                "Asserts that the element is visible with at-least the specified percentage. Default percent is 75%.",
              example:
                "await expect(element(by.id('loginButton'))).toBeVisible(38);",
              guidelines: [
            ...
            },
            {
              ...
              example:
                "await expect(element(by.id('slider'))).toHaveValue('0.5');",
            },
            {
            ...
            },
            {
              ...
              description:
                "Asserts that the element has the specified accessibility label.",
              example:
                "await expect(element(by.id('submitButton'))).toHaveLabel('Submit');",
            },
            {
              signature:
                "toHaveSliderPosition(normalizedPosition: number, tolerance?: number)",
              description:
                "Asserts that the slider is at a normalized position.",
              example:
            ...
            },
            {
              ...
              description:
                "Waits until the expectation is resolved or timeout occurs.",
              example:
...
await device.launchApp({ launchArgs: { someLaunchArg: 1234 } });`,
              guidelines: [
                "Use minimal parameters necessary for your launch scenario.",
              ],
            },
            {
            ...
            },
            {
              ...
              example:
                'const path = await device.takeScreenshot("home_screen");',
            },
            {
              signature: "device.getPlatform()",
              description:
                'Returns the current device platform ("ios" or "android").',
              example: "const platform = device.getPlatform();",
              guidelines: [
                "Use to conditionally execute platform-specific code.",
              ],
            },
            {
              signature: "device.openURL(url: string)",
              description:
                "Opens a deeplink within the app, or a URL in the browser.",
          ...
          items: [
            {
              ...
              description:
                "Selects an element within a web view (`WKWebView` or `RNCWebView`). Use when there is only one web view on the screen.",
              example: `
...
await web.element(by.web.id('login-button')).tap();
            ...
            {
              signature:
                "web(nativeMatcher: NativeMatcher).element(matcher: Matcher)",
              description:
                "Selects an element within a specific web view (`WKWebView` or `RNCWebView`) matched by a native matcher. Use when there are multiple web views on the screen.",
              example: `
...
await specificWebView.element(by.web.id('pay-button')).tap();
            ...
            {
              signature:
                "web(nativeMatcher: NativeMatcher).atIndex(index: number).element(matcher: Matcher)",
              description:
                "Selects an element within a specific web view at a given index (iOS only).",
              example: `
...
await secondWebView.element(by.web.id('search-button')).tap();
            ...
            },
            {
              ...
              description:
                "Matches web elements whose href attribute contains the specified string.",
            ...
            },
            {
              ...
              description:
                "Matches web elements by their value attribute (iOS only).",
            ...
            },
            {
              ...
              description:
                "Matches web elements by their label (iOS only, supports `asSecured()`).",
            ...
            },
            {
              ...
              description:
                "Matches web elements by accessibility type (iOS only, `asSecured()` only).",
            ...
            },
            {
              ...
              description:
                "Selects the web element at the specified index from matched elements.",
            ...
            },
            {
              ...
              guidelines: ["Supports `asSecured()` on iOS."],
            },
            {
              signature: "typeText(text: string)",
...
jestExpect(description).toContain('This product is made from the finest materials.');
            `,
              guidelines: ["Use for assertions on the element's text content."],
            },
            {
              signature: "scrollToView()",
              description:
                "Scrolls the web view to bring the element into view.",
...
await web.element(by.web.id('email-input')).typeText('user@example.com');
            ...
            },
            {
              ...
              description:
                "Moves the input cursor in a web view to the end of the element's content.",
              example: `
...
await web.element(by.web.id('message-box')).typeText(' Adding more text.');
            ...
            },
            {
              ...
              description:
                "Runs a JavaScript function on the web view element.",
              example: `
...
jestExpect(pageTitle).toBe('Dashboard - MyApp');
            ...
            },
            {
              signature: "toHaveText(text: string)",
              description:
                "Asserts that the web element has the specified text. Used with `expect()`.",
            ...
            },
            {
              signature: "toExist()",
              description:
                "Asserts that the web element exists. Used with `expect()`.",
