...
export const puppeteerPageApi  =  {
    ...
    captureSnapshotImage: async function (page : puppeteer.Page) {
      const fileName = `snapshot_puppeteer_${Date.now()}.png`;
      await page.screenshot({ path: fileName });
      return fileName;
    },
  
    captureViewHierarchyString: async function (page: puppeteer.Page) {
