...
if (page) {
  await page.getByLabel('Password').fill('secret');
            ...
            {
              signature: "await page.goBack([options])",
        ...
        if (page) {
          await page.goBack();
              ...
              guidelines: [
                ...
                "Options can modify waiting behavior.",
                "Useful for testing multi-page flows.",
              ],
            },
            {
              signature: "await page.dragAndDrop(source, target, [options])",
              description: "Drags an element to a target element or position.",
              example: `const page = getCurrentPage();
        if (page) {
          await page.dragAndDrop('#item', '#destination');
        }`,
              guidelines: [
                "Source and target can be selectors or locators.",
                "Automatically waits for elements to be visible and enabled.",
                "Handles mouse events to simulate drag-and-drop.",
                "Options can control the delay and force of the action.",
              ],
            },
            {
              signature: "await locator.check([options])",
        ...
        if (page) {
          await page.getByLabel('Accept Terms').check();
              ...
              guidelines: [
                "Use for input elements of type checkbox or radio.",
                "Automatically waits for the element to be visible and enabled.",
                "Ensures the element is checked; does nothing if already checked.",
                "Handles any necessary scrolling into view.",
              ],
            },
            {
              signature: "await locator.uncheck([options])",
        ...
        if (page) {
          await page.getByLabel('Subscribe to newsletter').uncheck();
              ...
              guidelines: [
                "Use for input elements of type checkbox.",
                "Automatically waits for the element to be visible and enabled.",
