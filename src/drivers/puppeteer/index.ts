...
export const PuppeteerPageApi  =  (safeContext : any) => ({
    apiCatalog: {
      context: {page : safeContext.page},
      categories: [
        {
          title: 'Matchers',
          items: [
            ...
            },
            {
              ...
              example: 'const elements = await page.$x("//button[text()=\'Submit\']");',
              guidelines: [
            ...
            },
            {
              ...
              description: 'Waits for an element matching the selector to appear in the DOM.',
              example: 'await page.waitForSelector(".loading-indicator", { visible: true });',
              guidelines: [
            ...
            },
            {
              ...
              description: 'Waits for an element matching the XPath expression to appear.',
            ...
            {
              signature: 'await page.waitForFunction(pageFunction[, options][, ...args])',
              description: 'Waits for a function to evaluate to a truthy value.',
              example: 'await page.waitForFunction(() => document.querySelector("#status").innerText === "Loaded");',
              guidelines: [
            ...
            },
            {
              ...
              example: 'await page.waitForTimeout(2000); // Waits for 2 seconds',
              guidelines: [
          ...
          items: [
            {
              ...
              description: 'Simulates a mouse click on the element matched by the selector.',
            ...
            },
            {
              ...
              description: 'Types text into an element matched by the selector.',
            ...
            },
            {
              ...
              example: 'await page.uploadFile("#file-input", "/path/to/file.png");',
              guidelines: [
          ...
          items: [
            {
              ...
              description: 'Asserts that a value is equal to an expected value.',
            ...
            },
            {
              ...
              description: 'Asserts that a string contains a specific substring.',
            ...
            },
            {
              ...
              example: 'const element = await page.$("#result"); expect(element).not.toBeNull();',
              guidelines: [
            ...
            },
            {
              ...
              description: 'Asserts that an element has the specified text content.',
              example: 'const element = await page.$(".message"); const text = await page.evaluate(el => el.textContent, element); expect(text).toBe("Operation successful");',
              guidelines: [
            ...
            },
            {
              ...
              example: 'const isVisible = await element.isIntersectingViewport(); expect(isVisible).toBe(true);',
              guidelines: [
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              example: 'await page.screenshot({ path: "screenshot.png", fullPage: true });',
              guidelines: [
            ...
            },
            {
              ...
              example: 'const cookies = await page.cookies("https://www.example.com");',
              guidelines: [
            ...
            },
            {
              ...
              example: 'await page.setCookie({ name: "session", value: "abcdef123456", domain: "example.com" });',
              guidelines: [
            ...
            },
            {
              ...
              example: 'const dimensions = await page.evaluate(() => { return { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight }; });',
              guidelines: [
            ...
            },
            {
              ...
              description: 'Navigates to a URL and returns the main resource response.',
              example: 'const response = await page.goto("https://www.example.com", { waitUntil: "networkidle0" });',
              guidelines: [
        ...
        },
        {
          ...
          items: [
            {
              signature: 'await page.screenshot([options])',
              description: 'Captures a screenshot of the page or a portion of it.',
    ...
    captureSnapshotImage: async () => {
        const currentPage = safeContext.page;
      
        if (!currentPage) {
          console.error('Page object is undefined');
          return null;
        }
      
        try {
          if (typeof currentPage.screenshot !== 'function') {
            console.error('screenshot method is not available on page object');
            return null;
          }
      ...
      captureViewHierarchyString: async () => {
        ...
        try {
          return await currentPage.evaluate(() => {
            ...
            const visibleDOM = traverse(document.body);
            const container = document.createElement('div');
            if (visibleDOM) {
              container.appendChild(visibleDOM);
            }
