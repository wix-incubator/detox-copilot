...
describe('CodeEvaluator', () => {
    ...
    describe('shared context', () => {
        ...
        it('should allow writing to shared context', async () => {
            const sharedContext = { value: 42 };
            const code = 'sharedContext.newValue = sharedContext.value * 2; return true;';
        ...
        it('should preserve shared context between evaluations', async () => {
            ...
            await codeEvaluator.evaluate('sharedContext.value = 42;', {}, sharedContext);
            
            // Second evaluation uses the stored value
            const result = await codeEvaluator.evaluate('return sharedContext.value;', {}, sharedContext);
