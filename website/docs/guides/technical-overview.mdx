...
import OverviewSVG from '/static/img/guides/copilot-overview.svg';

# Technical Overview

Wix Pilot integrates seamlessly with your testing environment by combining natural language processing with Detox's robust testing capabilities.

## Building Blocks of Wix Pilot

To enable Wix Pilot to work harmoniously with Detox and your app, it relies on several building blocks:
